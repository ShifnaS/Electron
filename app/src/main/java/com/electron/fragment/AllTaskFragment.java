...
public class AllTaskFragment extends Fragment implements PaginationAdapterCallback {
    ...
    private Call<ResultList> callApi() {
        return apiService.getOpenedCarList("get_all_past_appointment", 1,userId,"staff", currentPage);
    }
